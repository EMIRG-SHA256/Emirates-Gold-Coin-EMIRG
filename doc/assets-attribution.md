The following is a list of assets used in the emiratesgoldcoin source and their proper attribution.
...
### Info
* Designer: md2k7
* Site: https://emiratesgoldcointalk.org/index.php?topic=15276.0
...
### Info
* Designer: Jonas Schnelli (based on the original emiratesgoldcoin logo from Bitboy)
* License: MIT
